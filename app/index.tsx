...
import { useAuth, getToken, validateToken, clearToken } from "../services/auth";
...
export default function Index() {
  ...
  // const { key, request, response, promptAsync, resetAuth, exchangeToken } =
  //   useAuth();
